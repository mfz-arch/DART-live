...
const DynamicMap = dynamic(() => import("./DARTMapInner"), {
  ssr: false,
  loading: () => (
    <div className="w-full h-full min-h-[400px] bg-slate-50 flex flex-col items-center justify-center space-y-3">
      <div className="w-12 h-12 rounded-full border-4 border-emerald-500/30 border-t-[#006B38] animate-spin" />
